...
public class ContinentPopulationReportIT {

    private Connection con;
    private ContinentPopulationReport report;
    ...
    public void setUp() throws Exception {
        ...
        report = new ContinentPopulationReport(con);
    ...
    @Test
    void testGenerateAndPrintContinentReport() {
        report.generateAndPrintContinentReport("Europe");
